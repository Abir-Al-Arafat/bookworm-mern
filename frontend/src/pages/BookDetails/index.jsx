                ...
                <div className="form-group">
                  {editable ? (
                    ...
                    <div className="review">
                      ...
                      <p>{myReview}</p>
                      <p>Rating: {myRating}</p>
                      <button className="btn-primary" onClick={() => setEditable(!editable)}>{reviewExists ? "Edit" : "Add"}</button>
                      {reviewExists ? <button className="btn btn-danger" onClick={handleDelete}>Delete</button> : null}
                    </div>
                  )}
                </div>
