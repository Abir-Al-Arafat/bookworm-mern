      ...
      <form className="d-flex flex-column form-container" onSubmit={handleSubmit(onSubmit)}>
        <div className="form-group m-1">
          ...
          <Controller
            ...
            render={({ field }) => (
              <input maxLength={51} placeholder="Enter First Name" {...field} style={{ border: errors.firstname ? "1px solid red" : "" }} />
            )}
          />
        ...
        <div className="form-group m-1">
          ...
          <Controller
            ...
            render={({ field }) => (
              <input maxLength={51} placeholder="Enter Last Name" {...field} style={{ border: errors.lastname ? "1px solid red" : "" }} />
            )}
          />
        ...
        <div className="form-group m-1">
          ...
          <Controller
            ...
            render={({ field }) => <input maxLength={51} placeholder="Enter E-mail Address" {...field} style={{ border: errors.email ? "1px solid red" : "" }} />}
          />
        ...
        <div className="form-group m-1">
          ...
          <Controller
            ...
            render={({ field }) => <input type="number" onInput={(e) => e.target.value = e.target.value.slice(0, 12)} maxLength={11} placeholder="Enter Phone Number" {...field} style={{ border: errors.phone ? "1px solid red" : "" }} />}
          />
        ...
        <div className="form-group m-1">
          ...
          <Controller
            ...
            render={({ field }) => <input maxLength={51} placeholder="Enter Address" {...field} style={{ border: errors.address ? "1px solid red" : "" }} />}
          />
        ...
        <div className="form-group m-1">
          ...
          <Controller
            ...
            render={({ field }) => <input maxLength={51} placeholder="Enter City" {...field} style={{ border: errors.address ? "1px solid red" : "" }} />}
          />
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            render={({ field }) => <input onInput={(e) => e.target.value = e.target.value.slice(0, 5)} maxLength={5} placeholder="Enter Balance" type="number" {...field} />}
          />
